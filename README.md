...
![Version](https://img.shields.io/badge/Version-2.0.0-c8a2ff)
...
│ ├── beyond_shift.rpy # три фазы дня, состояние команды, эпилоги и «Новая смена+» версии 2.0
...
Текущая сборка проверена на Ren’Py 8.5.3: **56 тестов и 291 утверждение**.
