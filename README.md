...
![Version](https://img.shields.io/badge/Version-1.4.0-c8a2ff)
...
✔ отдельная вкладка дела V-13 с пятью следами и восстановленным каналом
...
✔ скрытая цепочка из пяти сигналов и декодирование канала Фиолетового Шторма
...
✔ 17 новых оригинальных звуков и четыре маршрутных музыкальных мотива
...
│ ├── living_shift.rpy # анимации, звук, осмотры, телефон и V-13 в версии 1.4
