...
![Version](https://img.shields.io/badge/Version-2.1.1-c8a2ff)
...
Патч 2.1.1 вручную перерабатывает повторяющиеся обороты повествования, делает начало плотнее и возвращает Лере, Виктору, Максу и Артёму более различимый ритм речи.
