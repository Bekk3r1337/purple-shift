...
![Version](https://img.shields.io/badge/Version-1.1.0-c8a2ff)
...
Телефон открывается кнопкой **«Телефон»** в нижнем меню или клавишей **P**. На мобильных устройствах используется кнопка интерфейса.
