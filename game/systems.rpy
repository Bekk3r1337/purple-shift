...
init python:
    ...
    def ps_ending_description(ending_id=None):
        ...
        descriptions = {
            "truth": _("Журналы восстановили, оборудование отправили на проверку, а твои показания вошли в дело."),
            "people": _("Ты остановил поток и вывел людей до перегрева линии."),
            "voice": _("Команды передавали от участка к участку, пока всех не пересчитали."),
            "leader": _("Ты сохранил рабочую линию и получил должность вместе с правом остановки."),
            "employee": _("Ты занял первое место. Виктор травмирован, а Лера может не выйти завтра."),
            "exit": _("Ты ушёл до конца смены и больше не подтвердил следующий выход."),
            "silence": _("Рейтинг аннулирован. Решение о следующей смене пока не принято."),
        }
