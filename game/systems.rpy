...
init python:
    ...
    def ps_ending_description(ending_id=None):
        ...
        descriptions = {
            "truth": "Журналы восстановили, оборудование отправили на проверку, а твои показания вошли в дело.",
            "people": "Ты остановил поток и вывел людей до перегрева линии.",
            "voice": "Команды передавали от участка к участку, пока всех не пересчитали.",
            "leader": "Ты сохранил рабочую линию и получил должность вместе с правом остановки.",
            "employee": "Ты занял первое место. Виктор травмирован, а Лера может не выйти завтра.",
            "exit": "Ты ушёл до конца смены и больше не подтвердил следующий выход.",
