...
define gui.accent_color = "#c8a2ff"      # акцент (фиолетовый)

## Цвет, используемый в текстовой кнопке, когда она не выбрана и не наведена.
define gui.idle_color = "#d8c7ff"        # обычный текст кнопок
...
define gui.muted_color = "#b8a6d9"       # вторичный текст
define gui.hover_muted_color = '#5b1e99'

## Цвета, используемые в тексте диалогов и выборов.
define gui.text_color = "#e9e3ff"        # основной текст
define gui.interface_text_color = "#e9e3ff"
