...
label chapter2_hook:
    ...
    menu:
        "Подтвердить смену сразу":
            ...
            n "Палец нажимает кнопку раньше, чем ты успеваешь передумать. Система отвечает зелёной галочкой. Сделка заключена."
...
label chapter3_second_shift:
    ...
    menu:
        ...
        "Сказать, что каждый отвечает за свой ТСД":
            ...
            newb "Поняла."
            n "Она отвечает быстро, торопясь закрыть тему до неприятных вопросов."
...
label chapter3_sorting_start:
    ...
    n "У сортировки другой ритм: коробки сваливаются сразу кучей — весь остаток ночи одним махом."
...
label chapter3_after_incident:
    ...
    n "Пиип."
    n "Линия продолжает работу, не замечая произошедшего."
