    ...
    ps_variant_messages = [
        {
            ...
            "status": "в сети",
            "incoming": [
                "Я уже отправила свою версию. Не проверяй, ладно? Я там могла криво написать, но отправила сама.",
                "Просто сохрани копию у себя.",
            ],
            "replies": [
                {
                    "id": "respect",
                    ...
                    "reaction": "Спасибо. Больше ничего не надо.",
        ...
        },
        {
            ...
            "incoming": [
                ...
                "Если попрошу обратно — напомни, что это говорит старая привычка.",
            ],
            "replies": [
                {
                    "id": "hold",
        ...
        },
        {
            ...
            "replies": [
                {
                    "id": "refuse_exception",
                    "title": "«Рука целее не станет.»",
                    "answer": "К последней смене рука целее не станет. Всё равно поговорим.",
        ...
        },
        {
            ...
            "status": "в сети",
            "incoming": [
                "Мне страшно. Без шутки. Второй раз переписывать не буду.",
                "Можешь не отвечать. Просто пусть хоть кто-то знает.",
            ],
            "replies": [
                {
                    "id": "present",
                    "title": "«Осталось. И я тоже.»",
                    "answer": "Я знаю. И я рядом.",
                    "reaction": "Принято. Спасибо.",
            ...
            "replies": [
                {
                    ...
                    "reaction": "Не хочу, чтобы меня однажды не досчитались. Вот. Сказал.",
        ...
        },
        {
            ...
            "status": "на смене",
            "incoming": [
                "Общий стоп открыт всем терминалам. Я это разрешил и записал под своей фамилией.",
                "Если спросят, отвечу сам.",
            ],
            "replies": [
                {
                    "id": "witness",
