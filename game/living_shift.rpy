...
init 12 python:
    ...
    ps_inspection_catalog = {
        "control_scan": {
            "title": _("ДИСПЕТЧЕРСКАЯ // ТИХИЙ ОСМОТР"),
            "subtitle": _("Выбери минимум две точки. Остальное смена оставит на следующий раз."),
            ...
            "hotspots": [
                {
                    "id": "buffer_log",
                    "title": _("Буфер B-04"),
                    "detail": _("В журнале есть сорок семь повторных привязок в одну секунду."),
                    "x": 310,
                    "y": 390,
                ...
                },
                {
                    "id": "camera_clock",
                    "title": _("Часы камеры"),
                    "detail": _("Видеопоток отстаёт от системного времени на одиннадцать минут."),
                    "x": 1210,
                    "y": 280,
                ...
                {
                    "id": "violet_frequency",
                    "title": _("Частота 13.7"),
                    "detail": _("На отключённом канале остаётся ровная фиолетовая полоса без источника."),
                    "x": 1510,
                    "y": 610,
        ...
        "packing_scan": {
            "title": _("УПАКОВКА // СЛЕДЫ ОШИБКИ"),
            "subtitle": _("Найди то, что не попало в служебную формулировку."),
            "background": "images/bg/packing_zone.jpg",
            "soundscape": "packing",
            "hotspots": [
                {
                    "id": "shift_seal",
                    "title": _("Сорванная пломба"),
                    "detail": _("Пломбу меняли после передачи участка, но в журнале этого нет."),
                    "x": 380,
                    "y": 680,
                ...
                {
                    "id": "duplicate_label",
                    "title": _("Двойная этикетка"),
                    "detail": _("Один товар получил два маршрута после зависания ТСД."),
                    "x": 990,
                    "y": 430,
                    "route": "supervisor",
                    "stat": ("ps_efficiency", 1),
                ...
                {
                    "id": "forgotten_glove",
                    "title": _("Перчатка у линии"),
                    "detail": _("Лера оставила её там, где пыталась одна остановить хвост."),
                    "x": 1500,
                    "y": 690,
                    "route": "newbie",
                    "stat": ("ps_humanity", 1),
        ...
        "lift_scan": {
            "title": _("ПОДЪЁМНИК // ПЕРЕД ЗАПУСКОМ"),
            "subtitle": _("Машина говорит следами износа. Нужно только остановиться и посмотреть."),
            "background": "images/bg/warehouse_inside.jpg",
            "soundscape": "warehouse",
            "hotspots": [
                {
                    "id": "dead_sensor",
                    "title": _("Датчик массы"),
                    "detail": _("Кабель перетёрт там, где его не видно с рабочего прохода."),
                    "x": 880,
                    "y": 270,
                ...
                {
                    "id": "service_tag",
                    "title": _("Сервисная бирка"),
                    "detail": _("Последний осмотр закрыли удалённо через семь минут после заявки."),
                    "x": 1280,
                    "y": 560,
                ...
                {
                    "id": "stop_line",
                    "title": _("Красная граница"),
                    "detail": _("Кнопка доступна, но безопасная линия почти полностью стёрта."),
                    "x": 290,
                    "y": 710,
                    "route": "supervisor",
        ...
        "service_scan": {
            "title": _("СЛУЖЕБНЫЙ КОРИДОР // НЕТ НА КАРТЕ"),
            "subtitle": _("Дверь закрыта. Сигнал - нет."),
            "background": "images/bg/service_corridor.jpg",
            "soundscape": "service",
            "hotspots": [
                {
                    "id": "relay_echo",
                    "title": _("Реле без питания"),
                    "detail": _("Щелчки повторяют ритм смены, хотя линия находится в другом корпусе."),
                    "x": 430,
                    "y": 350,
                    "storm": "shift_echo",
                    "route": "joker",
                ...
                },
                {
                    "id": "v13_manifest",
                    "title": _("Пломба V-13"),
                    "detail": _("Номер накладной совпадает с грузом, которого нет в реестре."),
                    "x": 1250,
                    "y": 600,
                ...
                {
                    "id": "dead_network",
                    "title": _("Сеть без имени"),
                    "detail": _("Телефон видит точку доступа за бетонной дверью. Уровень сигнала максимальный."),
                    "x": 1570,
                    "y": 300,
                    "route": "newbie",
                    "stat": ("ps_humanity", 1),
    ...
    ps_storm_fragment_catalog = [
        ("violet_stamp", _("Фиолетовая печать"), _("Краска реагирует на экран телефона.")),
        ("dead_channel", _("Мёртвый канал"), _("Рация отвечает после отключения питания.")),
        ("sealed_manifest", _("Накладная V-13"), _("Груз принят сектором, которого нет на карте.")),
        ("violet_frequency", _("Частота 13.7"), _("Полоса существует без передатчика.")),
        ("shift_echo", _("Эхо смены"), _("Служебное реле повторяет ритм работающей линии.")),
        ("camera_guest", _("Лишний сотрудник"), _("Камера видит фигуру, которой нет рядом с линией.")),
        ("future_message", _("Сообщение из завтра"), _("V-13 предупреждает об аварии раньше её начала.")),
        ("named_shift", _("Названная смена"), _("Отключённое табло перечисляет людей по именам.")),
    ]

    ps_storm_decoder_sequence = [
        ("violet", _("ФИОЛЕТОВЫЙ КАНАЛ")),
        ("silence", _("ПАУЗА")),
        ("echo", _("ЭХО СМЕНЫ")),
        ("violet", _("ФИОЛЕТОВЫЙ КАНАЛ")),
    ]
    ...
    ps_live_messages = [
        {
            ...
            "sender": _("Новичок"),
            "time": "18:44",
            "preview": _("Я сегодня скажу сама."),
            "route": "newbie",
            "requires_route": "newbie",
            "incoming": [
                _("Я сегодня скажу сама, если ТСД снова зависнет."),
                _("Можешь просто быть рядом. Не вместо меня."),
            ],
            "replies": [
                {
                    "id": "beside",
                    "title": _("«Буду рядом. Говорить будешь ты.»"),
                    "answer": _("Буду рядом. Но говорить будешь ты."),
                    "reaction": _("Договорились. Так даже лучше."),
                    "effects": {"ps_newbie_trust": 2, "ps_humanity": 1},
                },
                {
                    "id": "checklist",
                    "title": _("«Сначала соберём факты.»"),
                    "answer": _("Сначала код, время и операция. Потом разговор."),
                    "reaction": _("Уже записала шаблон. Свой."),
        ...
        },
        {
            ...
            "sender": _("Ветеран"),
            "time": "18:39",
            "preview": _("Не давай мне лезть одному."),
            "route": "veteran",
            "requires_route": "veteran",
            "incoming": [
                _("Если подъёмник снова покажет LIFT-09 - не давай мне лезть одному."),
                _("Да, это официальное разрешение остановить старого дурака."),
            ],
            "replies": [
                {
                    "id": "promise",
                    "title": _("«Остановлю и тебя, и подъёмник.»"),
                    "answer": _("Остановлю и тебя, и подъёмник."),
                    "reaction": _("Вот теперь можно работать."),
                    "effects": {"ps_team_unity": 1, "ps_endurance": 1},
                },
                {
                    "id": "repair",
                    "title": _("«Сначала заявка и блокировка.»"),
                    "answer": _("Сначала заявка, бирка и блокировка. Без ручного режима."),
                    "reaction": _("Правильно. Ручной режим не трогаем."),
        ...
        },
        {
            ...
            "sender": _("Шутник"),
            "time": "18:51",
            "preview": _("Если я замолчу - пересчитай людей."),
            "route": "joker",
            "requires_route": "joker",
            "incoming": [
                _("Если я вдруг замолчу - пересчитай людей."),
                _("Это не шутка. Поэтому сообщение автоматически удалится из моей биографии."),
            ],
            "replies": [
                {
                    "id": "together",
                    "title": _("«Считать будем вместе.»"),
                    "answer": _("Считать будем вместе. И вслух."),
                    "reaction": _("Ненавижу командную работу. Спасибо."),
                    "effects": {"ps_team_unity": 2, "ps_humor": 1},
                },
                {
                    "id": "honest",
                    "title": _("«Можешь не шутить со мной.»"),
                    "answer": _("Со мной можешь не шутить, если сил нет."),
                    "reaction": _("Ладно. Только не пугайся, если я правда замолчу."),
        ...
        },
        {
            ...
            "time": "19:03",
            "preview": _("Мне нужен второй голос."),
            "route": "supervisor",
            "requires_route": "supervisor",
            "incoming": [
                _("Если куратор попросит короткую версию, мне нужен свидетель."),
                _("Человек, который подтвердит время и коды."),
            ],
            "replies": [
                {
                    "id": "facts",
                    "title": _("«Буду говорить только по фактам.»"),
                    "answer": _("Буду говорить по фактам. Даже если они против нас обоих."),
                    "reaction": _("Именно поэтому я написал тебе."),
                    "effects": {"ps_supervisor_respect": 2, "ps_integrity": 1},
                },
                {
                    "id": "responsibility",
                    "title": _("«Решение всё равно подпишешь ты.»"),
                    "answer": _("Я принесу доказательства. Ответственность за решение останется твоей."),
                    "reaction": _("Справедливо."),
        ...
        },
        {
            ...
            "sender": "V-13",
            "time": "--:--",
            "preview": _("Смена слышит тебя."),
            "requires_storm_any": True,
            "incoming": [
                _("СМЕНА СЛЫШИТ ТЕБЯ."),
                _("СОБЕРИ ВОСЕМЬ СЛЕДОВ. НЕ ДОВЕРЯЙ ВРЕМЕНИ НА КАМЕРАХ."),
            ],
            "replies": [
                {
                    "id": "who",
                    "title": _("«Кто это?»"),
                    "answer": _("Кто это и откуда у вас мой номер?"),
                    "reaction": _("СЕКТОР ПОМНИТ НОМЕР РАНЬШЕ ТЕБЯ."),
                    "effects": {"ps_evidence": 1},
                },
                {
                    "id": "disconnect",
                    "title": _("«Отключиться от сети.»"),
                    "answer": _("Соединение разорвано пользователем."),
                    "reaction": _("СОЕДИНЕНИЕ ПРОДОЛЖАЕТСЯ."),
