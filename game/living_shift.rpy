...
init 12 python:
    ...
    ps_live_messages = [
        ...
        },
        {
            ...
            "replies": [
                ...
                },
                {
                    ...
                    "reaction": "Правильно. Ручной режим не трогаем.",
        ...
        },
        {
            ...
            "replies": [
                ...
                },
                {
                    ...
                    "reaction": "Ладно. Только не пугайся, если я правда замолчу.",
        ...
        },
        {
            ...
            "incoming": [
                "Если куратор попросит короткую версию, мне нужен свидетель.",
                "Человек, который подтвердит время и коды.",
            ],
            "replies": [
                {
                    "id": "facts",
