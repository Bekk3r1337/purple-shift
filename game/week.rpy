...
label chapter6_day_six:
    ...
    n "На шестой день у входа чисто. Слишком чисто. Лужи отогнали от дверей. Старые палеты убрали. Даже фиолетовая линия светит ровнее."
    ...
    n "Смена начинается показательно спокойно. На линии больше людей. Проблемные товары заранее убраны. Кажется, что склад действительно может работать нормально."
...
label chapter7_day_seven:
    ...
    n "Дорога знакома до мелочей. У каждого перекрёстка вспоминается свой день: где ты торопился, где промолчал и где впервые остановил работу, хотя от тебя ждали обратного."
    ...
    n "После этой недели рекламная фраза звучит совсем не так, как задумывали в отделе кадров."
    ...
    n "Первые два часа склад работает почти идеально. Поток идёт. Ячейки принимают. Табло зеленеет."
...
label ending_common:
    ...
    n "История этой недели закончилась. В архиве остались решения, сообщения и люди, с которыми ты дошёл до проходной."
