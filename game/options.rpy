...
Версия 1.3.1 «Следы смены» превращает семь дней в исследуемую историю: карта склада, четыре маршрута персонажей, память последствий, архив документов, галерея и скрытый сигнал Фиолетового Шторма.
