...
Версия 1.5.0 «Голоса смены» превращает должности в людей: Лера, Виктор, Макс и Артём получают личные истории на протяжении всей недели, телефон — живые чаты и профили, игрок — реальные рабочие решения, а V-13 начинает вмешиваться в обычные сцены и обращаться к смене по именам.
