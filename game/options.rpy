...
Версия 2.0.0 «По ту сторону смены» перестраивает семь дней вокруг трёх фаз: до работы, внутри потока и после проходной. Решения теперь меняют усталость, давление и решимость героя, доверие и раскол команды, поведение Фиолетового Шторма, финальный день и подробные эпилоги. После первого прохождения открываются карта решений и «Новая смена+».
