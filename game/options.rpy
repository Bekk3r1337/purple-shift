...
Версия 1.7.0 объединяет два крупных обновления. «Смена помнит» возвращает последствия прошлых решений, добавляет восемь внутренних состояний четырёх маршрутов, командные конфликты и полноценное расследование. «Лица смены» приносит новые кинематографические CG, развивающиеся музыкальные мотивы, живой телефон и истинный посткредитный эпизод «Нулевая смена».
