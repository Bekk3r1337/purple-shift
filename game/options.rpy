...
Версия 2.1.0 «Живая смена» делает четыре маршрута самостоятельной частью финала. Лера, Виктор, Макс и Артём получают отдельные разговоры шестого дня, собственные действия во время аварии и восемь личных исходов. Сценарий стал плотнее и естественнее, интерфейс больше не хранит названия старых обновлений, а сохранения 1.x и 2.0 автоматически получают новые поля.
