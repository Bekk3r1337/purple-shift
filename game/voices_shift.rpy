            ...
            "replies": [
                {
                    ...
                    "answer": "Вот это уже твоя инструкция. Признанием вины здесь и не пахнет.",
...
label ps_team_names:
    ...
    newb "Мы второй день рядом работаем, а всё ещё зовём друг друга по должностям. Если так пойдёт дальше, я навсегда останусь Новичком. Я Лера. Валерия, если кто-то вдруг решит оформить на меня очередную служебку."
    $ ps_newbie_name = "Лера"
...
label ps_route_week_scene(day):
    ...
    if day == 2:
        ...
        if ps_week_route == "newbie":
            ...
            with dissolve
            n "Макс стоит у автомата с водой и уже целую минуту молчит. Без привычной улыбки наконец видно, как сильно он вымотался."
        ...
        if ps_week_route == "newbie":
            ...
            p "Что с ним стало?"
            vet "Ушёл позже, чем собирался. Когда назад дороги уже не было. Я всё время вспоминаю его только после того, как сам делаю ту же глупость."
