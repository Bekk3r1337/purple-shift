...
init 15 python:
    ps_character_profiles = {
        "newbie": {
            ...
            "age": "22 года",
            "truth": "Больше самой ошибки она боится чужой формулировки, которая может навсегда стать её характеристикой.",
            "need": "Ей нужен человек, рядом с которым она сможет говорить сама - без опеки и готовых ответов за неё.",
            "avatar": "newb relief",
        },
        "veteran": {
            "name": "Виктор",
    ...
    ps_shift_plan_catalog = [
        {
            ...
            "detail": "На сложном секторе Лера работает в паре, Виктор чередует подъёмник с другими позициями, Макс остаётся там, откуда слышно всю линию.",
            "accent": "#72d99a",
        },
        {
            "id": "balanced",
    ...
    ps_voice_messages = [
        ...
        },
        {
            ...
            "voice_caption": "«Я переписала памятку. Сначала мои действия, потом отдельно - что показал ТСД. Так понятнее.»",
            "incoming": [
                "Я всё-таки записала вчерашнюю ошибку. По шагам, с кодом и временем.",
            ...
            "replies": [
                {
                    ...
                    "answer": "Вот это уже твоя инструкция. Здесь всё по шагам.",
                    "reaction": "Да. В этот раз я хотя бы понимаю, что произошло.",
            ...
            "replies": [
                {
                    ...
                    "reaction": "Правильно. И копию мне пришли.",
            ...
            "replies": [
                {
                    ...
                    "reaction": "Никаких гарантий. Но постараюсь написать прямо.",
        ...
        },
        {
            ...
            "replies": [
                ...
                },
                {
                    ...
                    "reaction": "Так и будет. Решение подпишу сам.",
...
label ps_route_week_scene(day):
    ...
    if day == 2:
        ...
        if ps_week_route == "newbie":
            ...
            $ ps_add_relationship_memory("Лера попросила проверить факты вместе и оставила решение за собой.")
            hide newb
...
screen ps_shift_assignment():
    ...
    frame:
        ...
        vbox:
            ...
            text "Смотри на цену каждого варианта: смене ещё жить с этим решением.":
                color "#c8b9d3"
                size 22
                xalign 0.5
