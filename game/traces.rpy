...
label ps_trace_d6_break:
    ...
    menu:
        "Сказать, что она уже может помогать другим":
            ...
            $ ps_newbie_trust += 2
            $ ps_humanity += 1
            $ ps_record_consequence("Лера впервые почувствовала, что на неё тоже можно опереться.")
...
label ps_trace_d6_dock:
    ...
    menu:
        ...
        "Спросить, почему он всё ещё остаётся":
            ...
            $ ps_humanity += 1
            $ ps_endurance += 1
            $ ps_record_consequence("Виктор признался: он остаётся ради людей, склад его давно не держит.")
