...
label ps_trace_d4_packing:
    ...
    menu:
        "Снять полную последовательность кодов":
            ...
            n "Номера складываются в простую цепочку: системную ошибку оказалось удобнее назвать человеческим именем."
...
label ps_route_climax:
    ...
    if ps_route_scene_id == "newbie":
        ...
        newb "Ты сказал, что ошибка — это событие. Сегодня я наконец перестала видеть в ней себя."
